...
export interface SyntiantTokenInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "CLOCK_MODE"
      | "DOMAIN_SEPARATOR"
...
export interface SyntiantToken extends BaseContract {
  connect(runner?: ContractRunner | null): SyntiantToken;
  waitForDeployment(): Promise<this>;

  interface: SyntiantTokenInterface;
